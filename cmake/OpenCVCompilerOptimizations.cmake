...
list(APPEND CPU_ALL_OPTIMIZATIONS RISCV)
...
elseif(RISCV)
  ocv_update(CPU_RISCV_TEST_FILE "${OpenCV_SOURCE_DIR}/cmake/checks/cpu_riscv.cpp")
  ocv_update(CPU_KNOWN_OPTIMIZATIONS "RISCV")
  ocv_update(CPU_RISCV_FLAGS_ON "")
  set(CPU_DISPATCH "RISCV" CACHE STRING "${HELP_CPU_DISPATCH}")
  set(CPU_BASELINE "RISCV" CACHE STRING "${HELP_CPU_BASELINE}")
